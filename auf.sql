...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=968957795ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Tables récentes" class="drop_button btn">Récentes</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=auf&table=formulaires">`auf`.`formulaires`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=auf&table=administrateurs">`auf`.`administrateurs`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=auf&table=users">`auf`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=auf&table=personal_access_tokens">`auf`.`personal_access_tokens`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=auf&table=password_resets">`auf`.`password_resets`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=auf&table=migrations">`auf`.`migrations`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=auf&table=failed_jobs">`auf`.`failed_jobs`</a></li></ul></div><div class="drop_list"><button title="Tables préférées" class="drop_button btn">Préférées</button><ul id="pma_favorite_list"><li class="warp_link">Pas de tables préférées.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="2d3a3b6f4d5b366454674d7764766271">
