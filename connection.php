...
<body>
    <header>
        <div class="container fluid">
            <div class="row">
                <div class="logo">
                   <a href="acceuil.html"> <img src="./images/index.png" alt=""></a>
                </div>
                    <div class="barre"></div>                
                <div class="trai">
                    <div class="bar"></div>
        ...
        <form class="row g-3 needs-validation" novalidate>
            <div class="menu">
                ...
                <div class="sub col-12">
                    <button class="btn btn-primary" type="submit"><a href="liste.php"> Envoyer</a></button>
                </div>
            </div>
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="but">
                   <a href="acceuil.html"><img src="./images/arton1259-f6040.png" width="250px" height="150px"></a>
                </div>
                <div class="ecrit">
                    <h3>
                        Contacts <br>
